  ...
  userLogin: async (req, res) => {
    try {
      ...
      if (!userInfo) {
        ...
        logMessage('info','logs/userLogin.log','Login failed123 for Login data = '+req.body.email+ 'Password = '+req.body.password);        return res.redirect("/login"); // Redirect back to form if email exists
      }
