...
module.exports = {
  ...
  uploadProfilePicture: async (req, res) => {
    try {
      ...
      res.status(200).json({ message: 'Profile picture uploaded successfully',status: 'success', profileImage: imagePath, thumbnailImage: thumbnailPath });
    } catch (error) {
  ...
  userLogin: async (req, res) => {
    try {
      ...
      logMessage('info','logs/userLogin.log','Login failed123 for Login data = '+req.body.email+ 'Password = '+req.body.password);
      ...
      if (!userInfo) {
        ...
        logMessage('error','logs/userLoginError.log','Login failed for Login data = '+req.body.email+ 'Password = '+req.body.password); 
